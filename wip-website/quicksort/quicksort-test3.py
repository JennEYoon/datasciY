...
##        print("quicksort end, while loop start:", lesser, pivot, greater)
##        result = quicksort(left)
##        print("lesser result", result, pivot, greater)
##        stop = True
##        return(result + [pivot] + greater)

####    # Recursive call to greater, if length greater > 1
##
##    Print("end of quicksort: ", result, lesser, pivot, greater)
