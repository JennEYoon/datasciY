...
#  R script files can be printed using WordPad. Save as .rtf printed file. 
#  Courier New, 9pt, Rt & Bottom margins 0.5", Top & Left 1.0".
#  Testing, pringting from R Console. OK, but can't change margins.
#----------------------------------------------------------------------------
