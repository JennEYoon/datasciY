...
> Feb 25. 2021, conda v update successful.  Need to load in "base" env.  
...
* 22nd Monday small group - chp10 NLP Deep Dive, changed.    
* March meetup chp 6,7 fastai.  
...
Write backprop code myself to remember it.  
Finish fastai in 2-3 months, April - May 2021, maybe? 
Pytorch udemy - basic.  
 ...
 * Purchased - Learn Python, c2018 book, Kindle v $17, found free PDF.  

### Feb 25 Th:  
  * WCC - cancelled  
  * Working on Keras, 4.5h, mostly getting dir path, file, %cd setup.  
    - updated conda v successful to conda base env.  
    - seaborn installed successful 
    - data file read successful, use specified path NOT relative cd.., too easy to run cell twice and end up 2 levels above.  
  * Repos merge prep - moved folders, delete duplicate folders/files.  
  * SEC-private -- to merge with histories.  
  * SEC-data -- renamed repo sec-ml (financial securities machine learning)  
  * fastai-app -- currently host software dev folders, fastai v2, keep for now. 
  * git-practice (private) -- can merge w histories to Jennifer-Yoon repo.  
  
------------------  8 source, 2 forked, 10 total repos. --------------    
