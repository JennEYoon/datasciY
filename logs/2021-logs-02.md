 ...
 * Reading Goodfellow - Deep Larning book, 
   - Monte Carlo methods chapter.  
     > Sampling and Monte Carlo Methods:  
     > "Many important technologies used to accomplish machine learning goals aee based on drawing samples from some probability distribution and using these sampes to ***form a Monte Carlo estimate*** of some desired quantity."
